...
//       {/* Decorative glow */}
//       {/* <div className="pointer-events-none absolute -bottom-40 right-0 h-96 w-96 rounded-full bg-primary-500/20 blur-3xl" /> */}
...
//           <span className="inline-flex items-center gap-2 rounded-full border border-primary-400/30 bg-primary-400/10 px-4 py-1.5 text-xs font-semibold uppercase tracking-widest text-primary-300 backdrop-blur-sm">
...
//             <button
//               type="button"
//               className="group inline-flex items-center justify-center gap-2 rounded-full bg-primary-500 px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-primary-500/30 transition-all hover:scale-105 hover:bg-primary-600 hover:shadow-primary-500/50"
//             >
//               Get Started
...
//                   <FaStar key={i} className="h-4 w-4 text-primary-400" />
//                 ))}
//               </div>
...
//                 className="w-full rounded-lg border border-zinc-300 px-4 py-2.5 text-zinc-900 outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-500/30"
//               />
//             </div>
...
//             <button
//               type="submit"
//               className="mt-2 w-full rounded-lg bg-primary-500 px-4 py-3 text-base font-semibold text-white shadow-lg shadow-primary-500/20 transition-all hover:bg-primary-600 hover:shadow-primary-500/40"
//             >
//               Get My Quote
//             </button>
//           </form>
...
export default function Hero() {
  ...
  return (
    <section className="relative isolate flex min-h-[92vh] w-full items-center overflow-hidden bg-[#061222]">
      <Image
        src="/Home/hero2.png"
        alt="Family protected by health insurance"
        fill
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#061222]/95 via-[#0B1B35]/85 to-[#102B4C]/55" />
      ...
      <div className="relative z-10 flex w-full flex-col gap-10 px-6 py-16 sm:py-20 lg:flex-row lg:items-center lg:justify-between lg:py-24">
        ...
        <div className="w-full max-w-md rounded-3xl border border-white/20 bg-white/95 p-6 shadow-2xl backdrop-blur-xl ring-1 ring-white/10 sm:p-8">
          <h2 className="text-xl font-bold text-[#061222]">
            Get a Free Quote
          </h2>
