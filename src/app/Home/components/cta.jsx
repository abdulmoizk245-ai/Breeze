...
export default function Cta() {
  return (
    <section className="relative w-full overflow-hidden bg-white px-6 py-16">
      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-900 px-8 py-16 text-center shadow-2xl shadow-emerald-900/20 sm:px-16">
        ...
        <div className="relative">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-emerald-50/90">
            ...
            trust Breeze with their coverage.
          </p>
