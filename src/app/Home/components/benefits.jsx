      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 sm:grid-cols-2">
          {BENEFITS.map(({ title, description, icon: Icon }, i) => (
            ...
            >
              {/* Large Number */}
              <span className="absolute right-6 top-5 font-serif text-6xl leading-none text-primary-500/10 transition duration-300 group-hover:text-primary-500/20">
                0{i + 1}
              </span>

              <div className="relative flex items-start gap-5">
                {/* Icon Box */}
                <span className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl border border-primary-100 bg-primary-50 transition duration-300 group-hover:scale-105 group-hover:border-primary-300 group-hover:bg-primary-500">
